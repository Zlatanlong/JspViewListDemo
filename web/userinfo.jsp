...
<center>
    ...
    <table width="600" cellpadding="0" cellspacing="0" border="1">
        ...
        <tr>
            ...
            <td class="content">&nbsp;<jsp:getProperty name="regUser" property="mypassword"/>
            </td>
        </tr>
        <tr>
...
//               String date = sdf.format(regUser.getBirthday());
                %>
                <jsp:getProperty name="regUser" property="birthday"/>
                <%--<%=date%>--%>
            </td>
        </tr>
        <tr>
        ...
        <tr>
            ...
            <td class="content">&nbsp;<jsp:getProperty name="regUser" property="introduce"/>
            </td>
        </tr>
        <tr>
            <td class="title">是否介绍协议：</td>
            <td class="content">&nbsp;<jsp:getProperty name="regUser" property="flag"/>
            </td>
        </tr>
    </table>
</center>
